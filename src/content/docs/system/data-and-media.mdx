...
<div className="my-8 grid gap-px border border-white/10 bg-white/10 sm:grid-cols-2 lg:grid-cols-3">
  ...
  <article className="bg-neutral-950 p-5"><p className="m-0 text-[0.58rem] tracking-[0.16em] text-amber-200 uppercase">Membership</p><p className="mt-3 mb-0 text-sm leading-6 text-neutral-400">Tiers, activation keys, receipt results, expiry state, and the data used to keep access up to date.</p></article>
  ...
  <article className="bg-neutral-950 p-5"><p className="m-0 text-[0.58rem] tracking-[0.16em] text-rose-200 uppercase">Messages</p><p className="mt-3 mb-0 text-sm leading-6 text-neutral-400">Newsletter subscribers, dashboard updates, dismissed and read items, cleared items, and Discord message references.</p></article>
  <article className="bg-neutral-950 p-5"><p className="m-0 text-[0.58rem] tracking-[0.16em] text-neutral-300 uppercase">Safe coordination</p><p className="mt-3 mb-0 text-sm leading-6 text-neutral-400">Discord verification checks, one-use event numbers, records that claim competition deletions, and locks for scheduled jobs.</p></article>
</div>
