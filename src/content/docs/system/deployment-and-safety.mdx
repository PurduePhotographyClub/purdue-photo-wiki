...
<div className="my-8 border-l-2 border-rose-300 bg-rose-300/[0.04] p-6">
  <p className="m-0 font-['Playfair_Display',Georgia,serif] text-xl leading-snug text-white">Use bootstrap only to create an environment. It is not the normal production setup.</p>
</div>
...
<div className="my-8 grid gap-px border border-white/10 bg-white/10 lg:grid-cols-3">
  <article className="bg-neutral-950 p-6">
    <p className="m-0 text-[0.58rem] tracking-[0.18em] text-sky-200 uppercase">Stored in Git</p>
  ...
  <article className="bg-neutral-950 p-6">
    <p className="m-0 text-[0.58rem] tracking-[0.18em] text-rose-200 uppercase">Stored as secrets</p>
  ...
  <article className="bg-neutral-950 p-6">
    <p className="m-0 text-[0.58rem] tracking-[0.18em] text-emerald-200 uppercase">Set when deployed</p>
