...
<div className="my-8 border-l-2 border-rose-300 bg-rose-300/[0.04] p-6">
  <p className="m-0 text-xl leading-8 font-semibold text-white">The API checks the parsed order again before it creates a key, sends an email, or updates Discord.</p>
</div>
...
<div className="my-10 grid gap-4 lg:grid-cols-2 [&>article]:border [&>article]:border-white/10">
  <article className="bg-neutral-950 p-6">
    <p className="m-0 text-[0.68rem] tracking-[0.18em] text-sky-200 uppercase">KV check</p>
  ...
  <article className="bg-neutral-950 p-6">
    <p className="m-0 text-[0.68rem] tracking-[0.18em] text-emerald-200 uppercase">D1 check</p>
