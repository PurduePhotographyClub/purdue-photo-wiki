...
<div className="my-10 grid gap-4 lg:grid-cols-2 [&>article]:border [&>article]:border-white/10">
  <article className="bg-neutral-950 p-6">
    <p className="m-0 text-[0.68rem] tracking-[0.18em] text-indigo-200 uppercase">Gateway to Worker</p>
  ...
  <article className="bg-neutral-950 p-6">
    <p className="m-0 text-[0.68rem] tracking-[0.18em] text-emerald-200 uppercase">Worker to gateway</p>
...
<div className="my-8 border-l-2 border-indigo-300 bg-indigo-300/[0.04] p-6">
  <p className="m-0 text-xl leading-8 font-semibold text-white">The signature shows who sent the event. The nonce stops the same event from running twice.</p>
</div>
