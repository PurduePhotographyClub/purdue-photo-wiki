...
<div className="my-8 grid gap-px border border-white/10 bg-white/10 md:grid-cols-3">
  <article className="bg-neutral-950 p-5">
    <p className="m-0 text-[0.58rem] tracking-[0.16em] text-rose-200 uppercase">Not trusted from a browser</p>
  ...
  <article className="bg-neutral-950 p-5">
    <p className="m-0 text-[0.58rem] tracking-[0.16em] text-sky-200 uppercase">Sent when needed</p>
  ...
  <article className="bg-neutral-950 p-5">
    <p className="m-0 text-[0.58rem] tracking-[0.16em] text-emerald-200 uppercase">Added by the website</p>
